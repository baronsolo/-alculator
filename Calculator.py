...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(300, 300, 225, 500)
        ...
        self.ostatok.move(60, 320)

        self.celodiv = QPushButton('//', self)
        self.celodiv.resize(50, 50)
        self.celodiv.move(115, 320)

        self.kvadrat = QPushButton(' ²', self)
        self.kvadrat.resize(50, 50)
        self.kvadrat.move(170, 320)
        ...
        self.celodiv.clicked.connect(self.celodiv_1)
        self.kvadrat.clicked.connect(self.kvadrat_1)

    def enterValue(self):
        if self.label.text() == 0:
            self.label.setText('')
        self.label.setText(self.label.text() + str(self.my_input))
